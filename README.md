...
This is the standard Voxel-Slam as below with added intensity attribute.
In config "  is_save_undistorted: 1"
Creates a subfolder under the normal output with added intensity attribute.
Not well tested, still some bad lines generated from voxelisation.
Purpose is primarily pointcloud consumption, not robotics/nav stack.
